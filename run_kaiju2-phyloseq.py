...
## kaiju-multi, kaiju2table and kaiju-addTaxonNames has to be in your PATH.
# which is part of the kaiju installation to add taxa names to each OTU.
# The files names.dmp and nodes.dmp from taxonomy of NCBI and kaiju.fmi (indexed nr ncbi files) are need to Kaiju.
# kaiju-multi, kaiju2table and kaiju-addTaxonNames has to be in your PATH.
import sys
